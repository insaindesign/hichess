...
const puzzles = [
  ...
  },
  {
    ...
    scenario: ["d4e5", "d6e5", "f4h2", "e5e4"],
  },
  {
    fen: "8/8/1p1k1p1p/3npp2/2B5/PP1K1PP1/7P/8 b - - 0 36",
    scenario: ["f5f4", "c4d5", "f4g3", "h2g3", "d6d5", "g3g4"],
  },
  {
  ...
  },
  {
    ...
    scenario: ["c7c5", "b4c5", "b6c5", "d3d6", "d8d6", "d1d6"],
  },
  {
    fen: "r5kr/pp1qb1p1/2p4p/3pPb1Q/3P4/2P1B3/PP4PP/R4RK1 b - - 1 17",
    scenario: ["f5e4", "h5f7", "g8h7", "f1f6", "e7f6", "f7d7"],
  },
].map(puzzleToLevel);

const getPuzzles = (): Promise<Level[]> =>
  new Promise((resolve) => {
    resolve(puzzles);
  });
